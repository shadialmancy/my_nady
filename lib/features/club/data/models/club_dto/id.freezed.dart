...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Id&&(identical(other.oid, oid) || other.oid == oid));
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Id&&(identical(other.oid, oid) || other.oid == oid));
}
