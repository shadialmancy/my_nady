...
mixin _$SubscriptionPlan {
 ...
 String? get id; String? get name; String? get description; String? get duration; num? get price;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,description,duration,price);

@override
String toString() {
  return 'SubscriptionPlan(id: $id, name: $name, description: $description, duration: $duration, price: $price)';
}
...
@useResult
$Res call({
 String? id, String? name, String? description, String? duration, num? price
});
...
/// Create a copy of SubscriptionPlan
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? name = freezed,Object? description = freezed,Object? duration = freezed,Object? price = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id,  String? name,  String? description,  String? duration,  num? price)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SubscriptionPlan() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.duration,_that.price);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? id,  String? name,  String? description,  String? duration,  num? price)  $default,) {final _that = this;
switch (_that) {
case _SubscriptionPlan():
return $default(_that.id,_that.name,_that.description,_that.duration,_that.price);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? id,  String? name,  String? description,  String? duration,  num? price)?  $default,) {final _that = this;
switch (_that) {
case _SubscriptionPlan() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.duration,_that.price);case _:
  return null;
...
class _SubscriptionPlan implements SubscriptionPlan {
   _SubscriptionPlan({this.id, this.name, this.description, this.duration, this.price});
...
/// Create a copy of SubscriptionPlan
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? name = freezed,Object? description = freezed,Object? duration = freezed,Object? price = freezed,}) {
