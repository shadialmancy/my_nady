...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RefreshResponseDto&&(identical(other.data, data) || other.data == data)&&(identical(other.meta, meta) || other.meta == meta));
}
...
@override
String toString() {
  return 'RefreshResponseDto(data: $data, meta: $meta)';
}
...
class _RefreshResponseDto implements RefreshResponseDto {
   _RefreshResponseDto({this.data, this.meta});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RefreshResponseDto&&(identical(other.data, data) || other.data == data)&&(identical(other.meta, meta) || other.meta == meta));
}
