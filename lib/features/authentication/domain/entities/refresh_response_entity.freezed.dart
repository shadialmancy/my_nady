...
$RefreshResponseEntityCopyWith<RefreshResponseEntity> get copyWith => _$RefreshResponseEntityCopyWithImpl<RefreshResponseEntity>(this as RefreshResponseEntity, _$identity);
  ...
  /// Serializes this RefreshResponseEntity to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RefreshResponseEntity&&(identical(other.data, data) || other.data == data)&&(identical(other.meta, meta) || other.meta == meta));
}
...
@override
String toString() {
  return 'RefreshResponseEntity(data: $data, meta: $meta)';
}
...
class _RefreshResponseEntity implements RefreshResponseEntity {
   _RefreshResponseEntity({this.data, this.meta});
  factory _RefreshResponseEntity.fromJson(Map<String, dynamic> json) => _$RefreshResponseEntityFromJson(json);
...
@override
Map<String, dynamic> toJson() {
  return _$RefreshResponseEntityToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RefreshResponseEntity&&(identical(other.data, data) || other.data == data)&&(identical(other.meta, meta) || other.meta == meta));
}
